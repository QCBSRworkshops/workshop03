...
Commençons par les bases ! Le paquet `ggplot2` est basé sur la Grammaire des Graphiques (GG), qui est un cadre pour la visualisation de données qui décompose chaque élément d'un graphique en composants individuels, créant ainsi des couches distinctes. En utilisant le système GG, nous pouvons construire des graphiques étape par étape pour des résultats flexibles et personnalisables. 
...
## Les couches de la grammaire des graphiques (GG) {#gg-layers}
...
**&#x267B; Rappel de l'atelier 2 - [*Charger et manipuler des données*](https://qcbsrworkshops.github.io/workshop02/book-fr/):**
