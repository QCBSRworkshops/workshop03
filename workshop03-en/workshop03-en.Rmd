...
![:faic](arrow-right)  point, line, histogram, box plot, error bar, significant value and linear regression
...
![](https://github.com/calligross/ggthemeassist/blob/master/examples/ggThemeAssist2.gif)

---
class: inverse, center, middle

# Fine-tuning your plots: `facet_grid()` and `facet_warp()` to change the arrangement of plots
...
```{r, eval=FALSE}
tips.gg <- ggplot(tips) +
  geom_point(aes(x = total_bill, y = tip/total_bill,
