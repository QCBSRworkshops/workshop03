...
[Multiple packages and functions](https://insileco.github.io/wiki/rgraphpkgs/) to achieve great visualization ("base R", lattice, plotly, rgl, plot3d, maps, etc.). We focus only on `ggplot2`. Here is an example:


```{r, echo=FALSE, fig.width=10, fig.height=5.8}
...
.center[![:scale 80%](images/ggplot functions geoms (cheatsheet).png)]
...
betterPairs(iris)
```
See [www.sthda.com/](http://www.sthda.com/english/wiki/scatter-plot-matrices-r-base-graphs) for further examples.


---
# Length vs width of iris' sepals
...
&#x267B; Cleaning up your dataset was covered in the previous workshop *Loading and manipulating data* see http://qcbs.ca/wiki/r_workshop2.
...
# Fine-tuning your plots (aes, scales)

## colour, shape, sizes, etc.
...
---
# Manually increasing colour contrast
...
iris.plot + scale_colour_manual(values = c("setosa" = "red",
  "versicolor" = "darkgreen", "virginica" = "blue"))
```
]
.pull-left[
**Classic**
...
![:scale 100%](images/Rcolour Brewers palette prez.png)


---
# Colours theme with RColorBrewer
...
Produce a colourful plot from built-in datasets such as `Iris`, `CO2` or `msleep`
