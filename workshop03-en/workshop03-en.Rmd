...
cat(
  qcbsRworkshops::first_slides(6, c('grid', 'gridExtra', 'ggplot2', 'ggpubr', 'ggsignif','ggdendro', 'maps', 'mapproj', 'RColorBrewer', 'psych'), lang = "fr")
)
```
...
```{r, echo=FALSE, fig.align="center", fig.width = 7, fig.height = 3.7}
...
.center[
![:scale 80%](images/boxplot_explain.png)
]
