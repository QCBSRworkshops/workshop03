...
## ----theme, include = FALSE, cache=FALSE---------------------------------
library(ggplot2)
...
## ---- echo=FALSE, fig.width=10, fig.height=7.5---------------------------
library(colorblindr)
cvd_grid(pp)
...
msleep.challenge4 + geom_violin() +
  ...
  labs(main = "Brain weight among different vore", y = "Brain weight (log10(Kg))") + 
  scale_fill_grey() + 
  theme_classic()
...
## ---- echo=FALSE, fig.align='center', fig.width=11, fig.height=7.5-------
library(tidyverse)
library(plotly)
# Scatterplot
p = ggplot(iris, 
