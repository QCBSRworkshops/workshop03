...
**2.** Learn and identify the basic dynamics on building figures following the layered *grammar of graphics*; 
...
While John Snow had to hand draw his map, we have computational resources that we can use to quickly represent our or _his_ data!
...
Recreation of John Snow’s original map of the 1854 cholera outbreak. The size of each black dot is proportional to the number of people who died from cholera at that location. The red dots indicate the location of public water pumps.
...
`ggplot2` was created by [Hadley Wickham](), and published as _A Layered Grammar of Graphics_ (2005). The inspiration comes from the _The Grammar of Graphics_ book (1999), from Leland Wilkinson.
...
**Facets** divides figures across panels:
 ...
 - `facet_grid()` does the as above, but can take different variables.
