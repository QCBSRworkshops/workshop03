...
**Data** provides the essential ingredients for the figure:
...
**Geometries** (`geom_*()`) provides shapes to the data:
...
**Facets** divide figures across panels:
...
.center[.alert[How can we graphically address these questions with `ggplot2`?]]
