...
pp + scale_colour_grey() +
  theme_minimal() + # Make backgorund white with gray gridlines 
  labs(title = "Minimal")
```
]
...
Here is a helpful infographic so you can customize your theme to your exact needs!

![:scale 90%](images/ggthemes.png)

If you want, you can even build your own theme and then apply it to all your figures to make them match. Here is an example:

```{r, echo = TRUE, eval = FALSE}
mytheme <- theme_bw() + # Create an object with all your theme settings
