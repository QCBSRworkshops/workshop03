...
Let's start with the basics! The package `ggplot2` is based on the Grammar of Graphics (GG), a layered framework for data visualization. In this framework a graphic is made of different layers. Using the GG system, we can build graphs step-by-step for customizable results. 
...
Let's try it out! Here are the basic steps to building a plot:
