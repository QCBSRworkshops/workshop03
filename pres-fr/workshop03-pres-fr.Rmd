...
en modifiant et en améliorant son contenu dans le cadre du <br>*Le*arning *a*nd *D*evelopment *A*ward*.
]
...
Tout le matériel de l'atelier se trouve sur le site [r.qcbs.ca/workshops/r-workshop-03/](https://r.qcbs.ca/workshops/r-workshop-03/).
]
...
##### Un exemple court et historique : avez-vous déjà entendu parler de John Snow ?

.pull-left3[
Dans les années 1850, on pensait que le choléra était transmis et propagé par un "mauvais air" ou de "mauvaises odeurs" provenant de matières organiques en décomposition, et l'épidémie soudaine et grave de choléra dans le quartier londonien de Soho était un mystère.

Le médecin John Snow a donc décidé d'interroger les habitants et de **cartographier les décès dus au choléra**.

Il a pu constater qu'il y avait un lien entre le choléra et l'eau potable contaminée : la plupart des décès étaient dus à des personnes dont l'accès le plus proche à l'eau était la pompe de Broad Street, où l'on a découvert par la suite que des bactéries fécales provenaient d'une fosse d'aisance voisine.
...
Alors que John Snow a dû dessiner sa carte à la main, nous avons l'avantage de disposer de ressources informatiques pour représenter des données rapidement !
...
.xsmall[Reconstitution de la carte originale de John Snow sur l'épidémie de choléra de 1854.]
...
_Temps pour discuter!_ <br>
_(S'il n'y a pas de volontaires, un nom sera choisi au hasard !)_
...
---
#### Explorer la structure des données: `GGally::ggpairs()`
